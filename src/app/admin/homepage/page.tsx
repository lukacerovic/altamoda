  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-[#1a1c1e] mt-1">{t("admin.homepageDesc")}</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-sm border border-stone-200 overflow-hidden">
            ...
            <div className="p-6">
              <p className="text-sm text-[#1a1c1e] mb-5">
                  ...
                  return (
                    <div key={slotIndex} className="flex flex-col gap-3">
                          ...
                          >
                            {heroUploading === slotIndex ? (
                              ...
                              <>
                                ...
                                <span className="text-sm text-[#1a1c1e]">Kartica {slotIndex + 1}</span>
                                <span className="text-xs text-[#1a1c1e]">Preporučeno: 800x1000px</span>
                              </>
                            )}
                          </button>
                        )}
                      ...
                      <div className="space-y-2.5">
                        <div>
                          <label className="block text-[10px] uppercase tracking-[0.18em] text-[#1a1c1e] font-medium mb-1">Mala oznaka (kicker)</label>
                          <input
                            type="text"
                            value={card.kicker}
                        ...
                        <div>
                          <label className="block text-[10px] uppercase tracking-[0.18em] text-[#1a1c1e] font-medium mb-1">Naslov</label>
                          <input
                            type="text"
                            value={card.title}
                        ...
                        <div>
                          <label className="block text-[10px] uppercase tracking-[0.18em] text-[#1a1c1e] font-medium mb-1">Opis (paragraf)</label>
                          <textarea
                        ...
                        <div>
                          <label className="block text-[10px] uppercase tracking-[0.18em] text-[#1a1c1e] font-medium mb-1">Tekst linka (CTA)</label>
                          <input
                            type="text"
                            value={card.cta}
                        ...
                        <div>
                          <label className="block text-[10px] uppercase tracking-[0.18em] text-[#1a1c1e] font-medium mb-1">Putanja linka</label>
                          <input
                            type="text"
                            value={card.href}
              ...
              >
                ...
                <div className="p-6">
                      ...
                      >
                        ...
                        {!section.readOnly && (
                          <button
                            ...
                            className="p-1 text-[#1a1c1e] hover:text-red-500 hover:bg-red-50 rounded sm:opacity-0 sm:group-hover:opacity-100 transition-all flex-shrink-0"
                  ...
                  {section.readOnly && products.length > 0 && (
                    <p className="mt-4 text-xs text-[#1a1c1e] italic">{t("admin.saleNote")}</p>
                  )}
                </div>
              </div>
            );
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-sm shadow-xl w-full max-w-2xl mx-4 flex flex-col" style={{ maxHeight: "80vh" }}>
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-stone-200">
              ...
              <button onClick={() => setAddModal(null)} className="p-2 text-[#1a1c1e] hover:text-black hover:bg-stone-100 rounded transition-colors">
                <X size={20} />
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto">
              {modalLoading ? (
                ...
                <p className="text-sm text-[#1a1c1e] text-center py-12">{t("admin.noProductsMatch")}</p>
              ) : (
                      ...
                      >
                        ...
                        <div className="w-10 h-10 rounded-lg bg-stone-100 flex items-center justify-center flex-shrink-0">
                          {product.image ? (
                            ...
                            <Package size={16} className="text-[#1a1c1e]" />
                          )}
                        </div>
                        <div className="min-w-0 flex-1">
