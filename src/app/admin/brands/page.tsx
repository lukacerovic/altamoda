          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {filteredBrands.map((brand) => (
              ...
              >
                ...
                <h3 className="text-sm font-semibold text-black group-hover:text-[#edb4bd] transition-colors">
                  {brand.name}
                </h3>
    ...
    <div>
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#edb4bd] text-white px-5 py-2.5 rounded-sm text-sm font-medium hover:bg-[#413d3a] transition-colors disabled:opacity-50"
        >
        ...
        {!isCreating && selectedBrand && (
          <div className="bg-white border border-stone-200 rounded-sm p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <button
                onClick={openPicker}
                className="flex items-center gap-2 border border-[#edb4bd] text-[#1a1c1e] px-4 py-2 rounded-sm text-sm font-medium hover:bg-[#edb4bd] hover:text-white transition-colors"
              >
                <Plus className="w-4 h-4" />
                Dodaj proizvode
              </button>
            ...
            <div className="flex items-center justify-between gap-3 p-5 border-t border-stone-200 flex-shrink-0">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-[#edb4bd] text-white px-5 py-2 rounded-sm text-sm font-medium hover:bg-[#413d3a] transition-colors disabled:opacity-50"
                >
