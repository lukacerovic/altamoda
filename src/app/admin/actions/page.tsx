    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-[#7A7F6A] mt-1">{t("admin.manageActionsDesc")}</p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-white rounded-sm border border-stone-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-[#a5a995]">{t("admin.totalActions")}</p>
        ...
        <div className="bg-white rounded-sm border border-stone-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-[#a5a995]">{t("admin.activeActions")}</p>
        ...
        <div className="bg-white rounded-sm border border-stone-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-[#a5a995]">{t("admin.scheduledActions")}</p>
        ...
        <div className="bg-white rounded-sm border border-stone-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-[#a5a995]">{t("admin.productsOnSale")}</p>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            {(["all", "active", "scheduled", "inactive"] as const).map(s => (
              <button key={s} onClick={() => setStatusFilter(s)} className={`px-3 sm:px-4 py-2 rounded-sm text-sm font-medium transition-colors ${statusFilter === s ? "bg-black text-white" : "bg-stone-100 text-[#7A7F6A] hover:bg-[#D8CFBC]"}`}>
      ...
      <div className="space-y-4">
            ...
            <div key={action.id} className="bg-white rounded-sm border border-stone-200 p-5 hover:shadow-sm transition-shadow">
              <div className="flex flex-col md:flex-row md:items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-sm text-[#7A7F6A]">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  <button onClick={() => openEdit(action)} className="p-2 text-[#a5a995] hover:text-secondary hover:bg-black/10 rounded-sm transition-colors">
                    <Edit3 size={18} />
                  </button>
                  <button onClick={() => deleteAction(action.id)} className="p-2 text-[#a5a995] hover:text-red-500 hover:bg-red-50 rounded-sm transition-colors">
                    <Trash2 size={18} />
                  </button>
                </div>
              </div>
              ...
              {action.products.length > 0 && (
                <div className="mt-4 pt-4 border-t border-[#FFFBF4]">
                  <div className="flex flex-wrap gap-2">
                        ...
                        <div key={p.id} className="flex items-center gap-2 bg-stone-100 rounded-sm px-3 py-2">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-1.5">
                              ...
                              <span className="text-[10px] text-[#a5a995] line-through">{p.originalPrice.toLocaleString()} RSD</span>
                            </div>
                          </div>
                        </div>
                      );
        ...
        {filtered.length === 0 && (
          <div className="bg-white rounded-sm border border-stone-200 p-12 text-center">
            ...
            <p className="text-sm text-[#7A7F6A] mb-4">{t("admin.createActionDesc")}</p>
        ...
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-full max-w-2xl bg-white shadow-2xl flex flex-col animate-slideInRight">
            ...
            <div className="px-6 py-4 border-b border-stone-200 flex items-center justify-between flex-shrink-0">
              ...
              <button onClick={() => setShowPanel(false)} className="p-1 text-[#a5a995] hover:text-black"><X size={20} /></button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              {/* Name */}
              <div>
                <label className="block text-sm font-medium text-[#11120D] mb-1.5">{t("admin.actionName")}</label>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-[#11120D] mb-1.5">{t("admin.discountType")}</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-[#11120D] mb-1.5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-[#11120D] mb-1.5">{t("admin.applyTo")}</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-[#11120D] mb-1.5">{t("admin.targetAudience")}</label>
              ...
              {form.target === "brand" && (
                <div>
                  <label className="block text-sm font-medium text-[#11120D] mb-1.5">{t("admin.selectBrand")}</label>
              ...
              {form.target === "category" && (
                <div>
                  <label className="block text-sm font-medium text-[#11120D] mb-1.5">{t("admin.selectCategory")}</label>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium text-[#11120D] mb-1.5">{t("admin.badge")}</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-[#11120D] mb-1.5">{t("admin.startDate")}</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-[#11120D] mb-1.5">{t("admin.endDate")}</label>
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <label className="text-sm font-medium text-[#11120D]">
                ...
                <div className="space-y-2 mb-3">
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      <Filter size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#a5a995]" />
                      <select
                        value={filterBrand}
                ...
                {productsLoading ? (
                  ...
                  <div className="max-h-64 overflow-y-auto border border-stone-200 rounded-sm divide-y divide-[#FFFBF4]">
                    {filteredProducts.length === 0 && (
                      <div className="px-4 py-8 text-center text-sm text-[#a5a995]">Nema proizvoda</div>
                    )}
                      ...
                      return (
                        <label key={p.id} className={`flex items-center gap-3 px-4 py-3 cursor-pointer hover:bg-stone-100 transition-colors ${selected ? "bg-stone-50" : ""}`}>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-[#a5a995]">{p.brand?.name || "—"} · {p.category?.nameLat || "—"} · {p.sku}</p>
                          </div>
                          <div className="text-right flex-shrink-0">
                            {form.value && Number(form.value) > 0 ? (
                              <>
                                <p className="text-sm font-bold text-secondary">{discounted.toLocaleString()} RSD</p>
                                <p className="text-[10px] text-[#a5a995] line-through">{p.priceB2c.toLocaleString()} RSD</p>
                              </>
                            ) : (
                      ...
                      return (
                        <div key={p.id} className="bg-white rounded-sm p-3 relative">
                          ...
                          <div className="flex items-center gap-1.5 mt-1">
                            ...
                            <span className="text-[10px] text-[#a5a995] line-through">{p.priceB2c.toLocaleString()} RSD</span>
                          </div>
                        </div>
                      );
                    })}
            ...
            <div className="px-6 py-4 border-t border-stone-200 flex items-center justify-end gap-3 flex-shrink-0">
              <button onClick={() => setShowPanel(false)} className="px-5 py-2.5 rounded-sm text-sm font-medium text-[#7A7F6A] hover:bg-stone-100 transition-colors">{t("admin.cancel")}</button>
