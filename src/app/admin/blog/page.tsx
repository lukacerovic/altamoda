    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-[#7A7F6A] mt-1">{posts.length} {t("admin.totalPosts")}</p>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-stone-100 border-b border-stone-200">
                <th className="px-6 py-3 text-left text-xs font-semibold text-[#7A7F6A] uppercase tracking-wider">{t("admin.title")}</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-[#7A7F6A] uppercase tracking-wider hidden md:table-cell">{t("admin.author")}</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-[#7A7F6A] uppercase tracking-wider hidden md:table-cell">{t("admin.category")}</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-[#7A7F6A] uppercase tracking-wider hidden sm:table-cell">{t("admin.date")}</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-[#7A7F6A] uppercase tracking-wider">{t("admin.status")}</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-[#7A7F6A] uppercase tracking-wider hidden sm:table-cell">{t("admin.views")}</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-[#7A7F6A] uppercase tracking-wider">{t("admin.actions")}</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#FFFBF4]">
              {filtered.map((post) => (
                <tr key={post.id} className="hover:bg-stone-100 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-stone-100 flex items-center justify-center flex-shrink-0">
                        <FileText size={18} className="text-[#a5a995]" />
                      </div>
                      <span className="text-sm font-medium text-black line-clamp-1">{post.title}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4 text-sm text-[#7A7F6A] hidden md:table-cell">{post.author}</td>
                  <td className="px-6 py-4 text-sm text-[#7A7F6A] hidden md:table-cell">{post.category}</td>
                  <td className="px-6 py-4 text-sm text-[#7A7F6A] hidden sm:table-cell">{post.date}</td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4 text-sm text-[#7A7F6A] hidden sm:table-cell">{post.views.toLocaleString()}</td>
                  <td className="px-6 py-4">
