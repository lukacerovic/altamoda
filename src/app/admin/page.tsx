    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <select
            ...
            className="px-3 py-2 bg-white border border-[#e5e5e5] rounded-lg text-sm text-[#333] cursor-pointer"
          >
          ...
          <button className="p-2 bg-white border border-[#e5e5e5] rounded-lg text-[#666] hover:text-[#1a1a1a] hover:border-[#c8a96e] transition-colors">
            <RefreshCw size={18} />
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-[#e5e5e5] p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-lg font-semibold text-[#1a1a1a]">Pregled Prihoda</h2>
            ...
            {revenueData.map((item) => (
              <div key={item.day} className="flex-1 flex flex-col items-center gap-2">
                <div className="w-full relative" style={{ height: "160px" }}>
                  <div
                    className="absolute bottom-0 w-full rounded-t-md bg-gradient-to-t from-[#c8a96e] to-[#e8d5b0] transition-all duration-500 hover:from-[#a8894e] hover:to-[#c8a96e]"
          ...
          <div className="mt-4 pt-4 border-t border-[#f0f0f0] flex items-center justify-between">
            <div>
              ...
              <p className="text-lg font-bold text-[#1a1a1a]">1.245.800 RSD</p>
            </div>
            <Link href="/admin/analytics" className="text-sm text-[#c8a96e] hover:text-[#a8894e] font-medium flex items-center gap-1">
        ...
        <div className="bg-white rounded-xl border border-[#e5e5e5] p-6">
          <h2 className="text-lg font-semibold text-[#1a1a1a] mb-4">Brze Akcije</h2>
          <div className="space-y-3">
            <Link
              href="/admin/products"
              className="flex items-center gap-3 p-3 rounded-lg hover:bg-[#f5f5f5] transition-colors group"
            >
              <div className="p-2 rounded-lg bg-[#c8a96e]/10 text-[#c8a96e] group-hover:bg-[#c8a96e] group-hover:text-white transition-colors">
                <Plus size={18} />
              </div>
              <div>
                <p className="text-sm font-medium text-[#1a1a1a]">Dodaj Proizvod</p>
            ...
            >
              ...
              <div>
                <p className="text-sm font-medium text-[#1a1a1a]">Obradi Porudžbine</p>
            ...
            >
              ...
              <div>
                <p className="text-sm font-medium text-[#1a1a1a]">B2B Odobrenja</p>
            ...
            >
              ...
              <div>
                <p className="text-sm font-medium text-[#1a1a1a]">Novi Blog Post</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-[#e5e5e5] overflow-hidden">
          <div className="p-6 border-b border-[#f0f0f0] flex items-center justify-between">
            <h2 className="text-lg font-semibold text-[#1a1a1a]">Poslednje Porudžbine</h2>
            <Link href="/admin/orders" className="text-sm text-[#c8a96e] hover:text-[#a8894e] font-medium flex items-center gap-1">
              ...
              <tbody className="divide-y divide-[#f0f0f0]">
                {recentOrders.map((order) => (
                  <tr key={order.id} className="hover:bg-[#fafafa] transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <button className="text-[#999] hover:text-[#c8a96e] transition-colors">
                        <Eye size={16} />
                      </button>
                    </td>
                  </tr>
        ...
        <div className="bg-white rounded-xl border border-[#e5e5e5] p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-[#1a1a1a]">Top Proizvodi</h2>
          </div>
          <div className="space-y-4">
            {topProducts.map((product, i) => (
              <div key={i} className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-[#f5f5f5] flex items-center justify-center text-xs font-bold text-[#c8a96e]">
                  {i + 1}
                </div>
      ...
      <div className="bg-white rounded-xl border border-[#e5e5e5] p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-lg font-semibold text-[#1a1a1a]">Upozorenja o Zalihama</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {lowStock.map((item, i) => (
            <div
            ...
            >
              <p className="text-sm font-medium text-[#1a1a1a] mb-2">{item.name}</p>
