    ...
    <div>
          ...
          <div key={bundle.id} className="bg-white rounded-sm border border-stone-200 overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-5">
              ...
              <div className="flex items-center gap-2 pt-3 border-t border-stone-100">
                <button className="flex-1 py-2 text-sm font-medium text-secondary hover:bg-black/5 rounded-sm transition-colors">
                ...
                <button onClick={() => deleteBundle(bundle.id)} className="py-2 px-3 text-sm font-medium text-red-500 hover:bg-red-50 rounded-sm transition-colors">
                  <Trash2 size={14} />
                </button>
              </div>
            </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={() => setShowModal(false)}>
          <div className="bg-white rounded-sm w-full max-w-3xl max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between p-6 border-b border-stone-200">
              <h2 className="font-serif text-xl font-bold text-black">{t("admin.newBundle")}</h2>
              <button onClick={() => setShowModal(false)} className="p-1 hover:bg-stone-100 rounded-sm"><X size={20} /></button>
            </div>
