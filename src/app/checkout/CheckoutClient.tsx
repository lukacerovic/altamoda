        ...
        <div className="flex items-center justify-between mb-8">
          {STEPS.map((s, i) => (
            <div key={s.key} className="flex items-center flex-1">
              ...
              {i < STEPS.length - 1 && (
                <div className={`flex-1 h-0.5 mx-3 ${i < stepIndex ? 'bg-black' : 'bg-[#dddbd9]'}`} />
              )}
            </div>
          ))}
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {step === 'contact' && isGuest && (
              <div className="bg-white rounded-sm shadow-sm p-6">
                <h2 className="text-lg font-bold text-[#1a1c1e] mb-4">{t('checkout.yourDetails')}</h2>
                <p className="text-sm text-[#1a1c1e] mb-4">{t('checkout.enterContactDetails')}</p>

                <div className="space-y-3">
                  <div>
                    <label className="block text-sm font-medium text-[#1a1c1e] mb-1">{t('checkout.fullName')} *</label>
                    <input
                      type="text"
            ...
            {step === 'address' && (
              <div className="bg-white rounded-sm shadow-sm p-6">
                <h2 className="text-lg font-bold text-[#1a1c1e] mb-4">{t('checkout.shippingAddress')}</h2>
            ...
            {step === 'shipping' && (
              <div className="bg-white rounded-sm shadow-sm p-6">
                <h2 className="text-lg font-bold text-[#1a1c1e] mb-4">{t('checkout.shippingMethod')}</h2>
                <div className="space-y-3">
                  {[
            ...
            {step === 'payment' && (
              <div className="bg-white rounded-sm shadow-sm p-6">
                <h2 className="text-lg font-bold text-[#1a1c1e] mb-4">{t('checkout.paymentMethod')}</h2>
                <div className="space-y-3">
                ...
                <div className="mt-4">
                  ...
                  <textarea value={notes} onChange={(e) => setNotes(e.target.value)} rows={3} placeholder={t('checkout.additionalNotes')} className="w-full border border-[#dddbd9] rounded px-4 py-3 text-sm resize-none focus:border-black focus:outline-none" />
                </div>
            ...
            {step === 'review' && (
              <div className="space-y-4">
                <div className="bg-white rounded-sm shadow-sm p-6">
                  <h2 className="text-lg font-bold text-[#1a1c1e] mb-4">{t('checkout.orderReview')}</h2>
                ...
                {/* Items */}
                <div className="bg-white rounded-sm shadow-sm p-6">
                  <h3 className="text-sm font-semibold text-[#1a1c1e] mb-4">{t('checkout.products')} ({items.length})</h3>
                  <div className="space-y-3">
                    {items.map((item) => (
                      <div key={item.productId} className="flex items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-[#1a1c1e] truncate">{item.name}</p>
                          <p className="text-xs text-[#1a1c1e]">x{item.quantity}</p>
                        </div>
          ...
          <div>
            <div className="bg-white rounded-sm shadow-sm p-6 sticky top-24">
              <h3 className="text-lg font-bold text-[#1a1c1e] mb-4" style={{ fontFamily: "'Noto Serif', serif" }}>{t('checkout.summary')}</h3>
