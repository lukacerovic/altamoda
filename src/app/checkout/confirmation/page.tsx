    ...
    <div className="min-h-screen bg-stone-100 flex items-center justify-center">
      <div className="max-w-md w-full mx-4">
        <div className="bg-white rounded-sm shadow-sm p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-black mb-2" style={{ fontFamily: "'Noto Serif', serif" }}>
          ...
          {orderNumber && (
            <div className="bg-[#faf7f2] rounded-lg p-4 mb-6">
              <div className="flex items-center justify-center gap-2 mb-1">
                ...
                <span className="text-sm font-semibold text-black">Broj porudžbine</span>
              </div>
          ...
          <div className="space-y-3">
            <Link href="/products" className="w-full bg-black hover:bg-stone-800 text-white py-3 rounded font-medium transition-colors flex items-center justify-center gap-2">
