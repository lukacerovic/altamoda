    ...
    <div className="min-h-screen bg-[#f5f0e8]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16 md:py-24 text-center">
          ...
          <div className="flex items-center justify-center gap-3">
            {[
              ...
              <div key={t.label} className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-3 min-w-[70px]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
          <p className="text-sm text-[#666]">{filtered.length} proizvoda</p>
          ...
          {filtered.map((product) => (
            <div key={product.id} className="bg-white rounded-xl overflow-hidden shadow-sm border border-[#e0d8cc]/50 group hover:shadow-md transition-all">
              <div className="relative overflow-hidden aspect-square">
                ...
                >
                  <Heart className={`w-4 h-4 ${liked.has(product.id) ? "fill-[#c0392b] text-[#c0392b]" : "text-[#666]"}`} />
                </button>
              </div>
              <div className="p-4">
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-xs text-[#999] line-through">{product.regularPrice.toLocaleString()} RSD</span>
                </div>
                <button className="w-full py-2.5 bg-[#c0392b] hover:bg-[#a93226] text-white text-sm font-medium rounded-lg transition-colors">
                  Dodaj u korpu
                </button>
              </div>
            </div>
