      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="bg-[#FFFFFF] border-b border-[#D8CFBC]">
          <div className="max-w-5xl mx-auto px-4 py-8 md:py-12 text-center">
            ...
            {brand.description && (
              <p className="mt-4 text-[#2e2e2e] text-lg max-w-2xl mx-auto leading-relaxed">
                {brand.description}
              </p>
            )}
            <div className="mt-3 flex items-center justify-center gap-6 text-sm text-[#2e2e2e]">
                ...
                {products.map((product) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-3">
                        <p className="text-[11px] text-[#2e2e2e] uppercase tracking-wider mb-1">
                          {product.brand?.name}
                        </p>
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-sm font-bold text-[#2e2e2e]">
                            {product.price.toLocaleString("sr-RS")} <span className="text-[10px] font-semibold text-[#2e2e2e]">RSD</span>
                          </span>
                          {hasDiscount && (
                            <span className="text-xs text-[#2e2e2e] line-through">
