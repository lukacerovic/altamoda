      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="bg-[#FFFFFF] border-b border-[#dddbd9]">
          <div className="max-w-5xl mx-auto px-4 py-16 md:py-20 text-center">
            <h1
              className="text-3xl md:text-4xl font-bold text-[#1a1c1e] tracking-wide"
              style={{ fontFamily: "'Noto Serif', serif" }}
            >
              {t("nav.ourBrands")}
            </h1>
            <p className="mt-3 text-[#1a1c1e] text-lg max-w-xl mx-auto">
              ...
              >
                <div className="h-16 flex items-center justify-center mb-6">
                  {brand.logoUrl ? (
                    ...
                    <span
                      className="text-3xl font-bold text-[#dddbd9] group-hover:text-[#1a1c1e] transition-colors"
                      style={{ fontFamily: "'Noto Serif', serif" }}
                    >
                      {brand.name}
                    </span>
