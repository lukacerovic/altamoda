      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="bg-[#FFFFFF] border-b border-[#D8CFBC]">
          <div className="max-w-5xl mx-auto px-4 py-16 md:py-20 text-center">
            ...
            <p className="mt-3 text-[#2e2e2e] text-lg max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {brands.map((brand) => (
              ...
              >
                ...
                {brand.description && (
                  <p className="text-sm text-[#2e2e2e] text-center mt-2 line-clamp-2">{brand.description}</p>
                )}
                <div className="flex items-center justify-center gap-2 mt-4 text-sm text-[#2e2e2e] group-hover:text-[#2e2e2e] transition-colors">
