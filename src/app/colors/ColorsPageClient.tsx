    ...
    <div className="min-h-screen bg-[#FFFFFF]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#293133]/65">{t("colors.subtitle")}</p>
        </div>
            ...
            <button
              ...
              className={`px-6 py-2.5 rounded-full text-sm font-medium whitespace-nowrap transition-colors ${
                activeBrand === b.slug
                  ...
                  : "bg-white text-[#293133]/65 border border-[#D8CFBC] hover:border-black"
              }`}
            >
        ...
        <div className="bg-white rounded-sm shadow-sm p-4 mb-6">
          <div className="flex flex-wrap items-center gap-4">
            ...
            <button
              ...
              className="sm:hidden flex items-center gap-2 px-4 py-2 bg-[#FFFFFF] rounded-sm text-sm text-[#293133]/65"
            >
            ...
            <div className="hidden sm:flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs font-semibold text-[#293133]/65 uppercase">{t("colors.lightLevel")}</span>
                <div className="flex gap-1">
                  <button
                    onClick={() => setFilterLevel(null)}
                    className={`px-2 h-7 rounded text-xs font-medium transition-colors ${
                      !filterLevel ? "bg-black text-white" : "bg-[#FFFFFF] text-[#293133]/65 hover:bg-[#D8CFBC]"
                    }`}
                  >
                    {t("colors.all")}
                  </button>
                  {ALL_LEVELS.map((l) => (
                    <button
                      ...
                      className={`w-7 h-7 rounded text-xs font-medium transition-colors ${
                        filterLevel === l ? "bg-black text-white" : "bg-[#FFFFFF] text-[#293133]/65 hover:bg-[#D8CFBC]"
                      }`}
                    >
                      {l}
                    </button>
              ...
              {/* Undertone filter */}
              <div className="flex items-center gap-2">
                <span className="text-xs font-semibold text-[#293133]/65 uppercase">{t("colors.undertone")}</span>
                <div className="flex gap-1 flex-wrap">
                  <button
                    onClick={() => setFilterUndertone(null)}
                    className={`px-2 h-7 rounded text-xs font-medium transition-colors ${
                      !filterUndertone ? "bg-black text-white" : "bg-[#FFFFFF] text-[#293133]/65 hover:bg-[#D8CFBC]"
                    }`}
                  >
                    {t("colors.all")}
                  </button>
                  {UNDERTONES.map((ut) => (
                    <button
                      ...
                      className={`px-2 h-7 rounded text-xs font-medium transition-colors ${
                        filterUndertone === ut.key ? "bg-black text-white" : "bg-[#FFFFFF] text-[#293133]/65 hover:bg-[#D8CFBC]"
                      }`}
                    >
            ...
            <div className="flex border border-[#D8CFBC] rounded-sm overflow-hidden">
              <button
                ...
                className={`p-2 ${viewMode === "matrix" ? "bg-black text-white" : "bg-white text-[#293133]/65 hover:bg-[#FFFFFF]"}`}
              ...
              <button
                ...
                className={`p-2 ${viewMode === "grid" ? "bg-black text-white" : "bg-white text-[#293133]/65 hover:bg-[#FFFFFF]"}`}
          ...
          {showMobileFilters && (
            <div className="sm:hidden mt-4 pt-4 border-t border-[#D8CFBC] space-y-4">
              <div>
                <span className="text-xs font-semibold text-[#293133]/65 uppercase mb-2 block">{t("colors.lightLevel")}</span>
                <div className="flex gap-1.5 flex-wrap">
                  <button
                    onClick={() => setFilterLevel(null)}
                    className={`w-8 h-8 rounded text-xs font-medium ${!filterLevel ? "bg-black text-white" : "bg-[#FFFFFF] text-[#293133]/65"}`}
                  >
                    {t("colors.all")}
                  </button>
                  {ALL_LEVELS.map((l) => (
                    <button
                      key={l}
                      onClick={() => setFilterLevel(filterLevel === l ? null : l)}
                      className={`w-8 h-8 rounded text-xs font-medium ${filterLevel === l ? "bg-black text-white" : "bg-[#FFFFFF] text-[#293133]/65"}`}
                    >
                      {l}
                    </button>
                  ))}
              ...
              <div>
                <span className="text-xs font-semibold text-[#293133]/65 uppercase mb-2 block">{t("colors.undertone")}</span>
                <div className="flex gap-1.5 flex-wrap">
                  <button
                    onClick={() => setFilterUndertone(null)}
                    className={`px-3 h-8 rounded text-xs font-medium ${!filterUndertone ? "bg-black text-white" : "bg-[#FFFFFF] text-[#293133]/65"}`}
                  >
                    {t("colors.all")}
                  </button>
                  {UNDERTONES.map((ut) => (
                    <button
                      key={ut.key}
                      onClick={() => setFilterUndertone(filterUndertone === ut.key ? null : ut.key)}
                      className={`px-3 h-8 rounded text-xs font-medium ${filterUndertone === ut.key ? "bg-black text-white" : "bg-[#FFFFFF] text-[#293133]/65"}`}
                    >
                      {language === "en" ? ut.label : ut.labelSr}
                    </button>
                  ))}
            ...
            {recentlyViewed.length > 0 && !hasActiveFilters && (
              <div className="mb-6">
                <div className="flex items-center gap-2 mb-3">
                  <Clock size={14} className="text-[#293133]/65" />
                  <span className="text-xs font-semibold text-[#293133]/65 uppercase tracking-wider">{t("colors.recentlyViewed")}</span>
                </div>
                <div className="flex gap-2 overflow-x-auto pb-2">
                  {recentlyViewed.map((c) => (
                    ...
                    >
                      ...
                      <span className="text-xs font-medium text-[#293133]/65">{c.shadeCode}</span>
                    </button>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-white rounded-sm shadow-sm overflow-hidden">
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="bg-[#FFFFFF]/50">
                        <th className="sticky left-0 z-10 bg-[#FFFFFF]/80 backdrop-blur-sm px-4 py-3 text-left text-xs font-semibold text-[#293133]/65 uppercase w-44">
                          {t("colors.lightLevel")}
                        </th>
                        {matrixData.undertones.map((ut) => (
                          <th key={ut} className="px-3 py-3 text-center text-xs font-semibold text-[#293133]/65 uppercase min-w-[72px]">
                            {getUndertoneName(ut)}
                          </th>
                        ))}
                      </tr>
                        ...
                        <tr key={level} className="border-t border-[#D8CFBC] hover:bg-[#FFFFFF]/50 transition-colors">
                          <td className="sticky left-0 z-10 bg-white px-4 py-3">
                            <div className="flex items-center gap-3">
                              ...
                              <span className="text-xs text-[#293133]/65 hidden sm:block">{getLevelName(level)}</span>
                            </div>
                          </td>
                          {matrixData.undertones.map((ut) => {
                                  ...
                                  <div className="flex flex-wrap gap-1.5 justify-center">
                                    {cellColors.map((c) => (
                                      ...
                                      >
                                        ...
                                        />
                                        <span className="text-[9px] text-[#293133]/65 block mt-0.5 font-medium">{c.shadeCode}</span>
                                        {/* Tooltip */}
                ...
                {displayColors.length === 0 && !loading && (
                  <div className="p-12 text-center">
                    <p className="text-[#293133]/65">{t("colors.noColors")}</p>
                  </div>
                )}
              </div>
            )}
                  ...
                  <div className="grid grid-cols-5 sm:grid-cols-8 md:grid-cols-10 gap-3">
                    {displayColors.map((color) => (
                      ...
                      >
                        ...
                        />
                        <span className="text-[10px] text-[#293133]/65 font-medium">{color.shadeCode}</span>
            ...
            <div className="hidden lg:block w-80 flex-shrink-0">
              <div className="bg-white rounded-sm shadow-sm p-6 sticky top-24">
                <button
                  ...
                  className="absolute top-3 right-3 text-[#293133]/65 hover:text-[#293133]/65"
                >
                  <X className="w-4 h-4" />
                </button>
                ...
                <div className="mt-6 pt-4 border-t border-[#D8CFBC]">
                  <p className="text-xs font-semibold text-[#293133]/65 uppercase tracking-wider mb-3">{t("colors.similarShades")}</p>
                    ...
                    {displayColors
                      ...
                      .map((c) => (
                        ...
                        >
                          ...
                          <span className="text-[10px] font-medium text-[#293133]/65">{c.shadeCode}</span>
                        </button>
                      ))}
                  </div>
                </div>
          ...
          <div className="lg:hidden fixed inset-x-0 bottom-0 bg-white rounded-t-2xl shadow-2xl z-50 p-6 border-t border-[#D8CFBC]">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="ml-auto text-right">
                <p className="text-sm text-[#293133]/65">{t("colors.level")} {selectedColor.level} · {selectedColor.undertoneName}</p>
