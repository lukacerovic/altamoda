  ...
  return (
    <>
      ...
      <main className="bg-[#FFFFFF] text-[#2e2e2e]">
        ...
        {/* Stats Bar */}
        <section className="bg-[#293133]/85 text-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              <div className="order-2 lg:order-1">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-6 -right-6 bg-[#293133]/85 p-6 md:p-8 text-white max-w-[280px] rounded-sm shadow-xl">
              ...
              <div className="order-1 lg:order-2">
                ...
                <div className="w-12 h-px bg-[#1a1d1f]/90 mb-8" />
                <p className="text-lg text-[#2e2e2e] leading-relaxed mb-8">
                  {t("education.introText")}
                </p>
                <div className="flex items-center gap-3 text-[#293133]/65">
        ...
        <section className="py-24 md:py-32 bg-[#FFFFFF]">
          <div className="max-w-screen-2xl mx-auto px-6 md:px-8">
            <div className="max-w-3xl mx-auto text-center mb-16">
              <GraduationCap className="w-10 h-10 text-[#293133]/65 mx-auto mb-6" />
              <h2 className="font-serif text-4xl md:text-5xl mb-6">
                {t("education.educationTitle")}
              </h2>
              <div className="w-12 h-px bg-[#1a1d1f]/90 mx-auto mb-8" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16">
              <div className="bg-white p-10 md:p-12 rounded-sm shadow-sm border-l-4 border-[#1a1d1f]/30">
              ...
              <div>
                ...
                <div className="bg-[#FFFFFF] p-8 rounded-sm">
                  ...
                  <div className="space-y-3">
                    <a href="tel:+381113066333" className="flex items-center gap-3 text-[#2e2e2e] hover:text-[#293133]/65 transition-colors">
                      <Phone className="w-4 h-4" />
                      <span className="text-sm">+381 11 306 6333</span>
                    </a>
                    <a href="tel:+381646473142" className="flex items-center gap-3 text-[#2e2e2e] hover:text-[#293133]/65 transition-colors">
                      <Phone className="w-4 h-4" />
                      <span className="text-sm">+381 64 647 3142</span>
                    </a>
                    <a href="mailto:info@id-academy.com" className="flex items-center gap-3 text-[#2e2e2e] hover:text-[#293133]/65 transition-colors">
                      <Mail className="w-4 h-4" />
          ...
          <div className="relative max-w-screen-2xl mx-auto px-6 md:px-8 text-center">
            ...
            <div className="max-w-xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a
                  href="mailto:info@id-academy.com"
                  className="inline-flex items-center gap-2 bg-[#293133]/85 text-white px-8 py-4 text-sm font-medium tracking-wide hover:bg-[#1a1d1f]/90 transition-colors"
                >
                  <Mail className="w-4 h-4" />
                  info@id-academy.com
