  ...
  return (
    <>
      ...
      >
          ...
          <div className="max-w-[1240px] mx-auto px-6 md:px-14 py-24 md:py-32">
            <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-12 lg:gap-20">
              <div className="lg:sticky lg:top-32 lg:self-start">
                <div
                  className="italic text-[14px] text-[#413d3a] mb-3.5"
                  style={{ fontFamily: "'Cormorant Garamond', serif" }}
                >
                  Nº 01
                </div>
                ...
                <div className="w-12 h-px bg-[#1a1c1e]/40 mb-5" />
                <p className="text-[13px] text-[#413d3a] leading-[1.7] max-w-[240px]">
                  {t("about.heroLead")}
                </p>
              </div>
              <div>
                ...
                <p
                  className="text-[22px] md:text-[24px] leading-[1.45] font-light mb-8 max-w-[720px] text-[#1a1c1e]"
                  style={{ fontFamily: "'Cormorant Garamond', serif" }}
                >
                  {withEm(t("about.introParagraph"))}
                </p>
                <p className="text-[15px] text-[#1a1c1e] leading-[1.85] mb-5 max-w-[680px]">
                ...
                <p className="text-[15px] text-[#1a1c1e] leading-[1.85] mb-5 max-w-[680px]">
                  ...
                  <Link
                    href="/education"
                    className="italic text-[#1a1c1e] border-b border-[#1a1c1e] pb-px hover:text-[#413d3a] hover:border-[#413d3a] transition-colors"
                ...
                <p className="text-[15px] text-[#1a1c1e] leading-[1.85] max-w-[680px]">
          ...
          <div className="max-w-[1240px] mx-auto px-6 md:px-14 py-24 md:py-30" style={{ paddingTop: "120px", paddingBottom: "120px" }}>
            <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-12 lg:gap-20 items-start">
              <div>
                ...
                <div className="w-12 h-px bg-[#1a1c1e]/40" />
              </div>
              <div>
                <div
                  className="italic font-light leading-[1.4] tracking-[-0.005em] max-w-[820px] text-[#1a1c1e]"
                  style={{
                    fontFamily: "'Cormorant Garamond', serif",
                ...
                <span
                  className="italic block mt-8 text-[#413d3a] text-[26px]"
                  style={{ fontFamily: "'Cormorant Garamond', serif" }}
                >
                  {t("about.welcome")}
                </span>
        ...
        ════════════════════════════════════════════════════════════ */}
        <section id="partner" className="bg-[#1a1c1e] text-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-20 items-center">
              <div>
                ...
                <div className="flex items-center gap-3.5 flex-wrap">
                  <Link
                    href="/account/login"
                    className="inline-flex items-center gap-2.5 bg-white text-[#1a1c1e] px-7 py-3.5 text-[11px] uppercase tracking-[0.22em] font-medium rounded-full border border-white hover:bg-[#1a1c1e] hover:text-white hover:border-white transition-colors"
                  >
                    {t("about.ctaButton")} <ArrowRight className="w-3 h-3" />
                  </Link>
                  <Link
