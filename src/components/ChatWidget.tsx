      ...
      <div className="w-[350px] h-[500px] bg-white rounded-sm flex flex-col overflow-hidden border border-[#D8CFBC] shadow-xl">
        ...
        <div className="bg-black px-4 py-3 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-sm bg-white/10 flex items-center justify-center">
              <Sparkles className="w-5 h-5 text-[#293133]/65" />
            </div>
            <div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-[#FFFFFF]">
          ...
          {isTyping && (
            <div className="flex justify-start">
              <div className="bg-white text-[#293133]/65 px-4 py-3 rounded-sm rounded-bl-none border border-[#D8CFBC]">
                <div className="flex gap-1">
                  <span className="w-1.5 h-1.5 bg-[#293133]/85 rounded-full animate-bounce" style={{ animationDelay: "0ms" }} />
                  <span className="w-1.5 h-1.5 bg-[#293133]/85 rounded-full animate-bounce" style={{ animationDelay: "150ms" }} />
                  <span className="w-1.5 h-1.5 bg-[#293133]/85 rounded-full animate-bounce" style={{ animationDelay: "300ms" }} />
                </div>
              </div>
            </div>
          )}
            ...
            <div className="flex flex-wrap gap-2">
              {quickReplies.map((reply) => (
                <button
                  ...
                  className="px-3 py-1.5 text-[10px] font-bold uppercase tracking-widest border border-[#D8CFBC] text-[#293133]/65 rounded-sm hover:bg-black hover:text-white hover:border-black transition-colors"
                >
                  {reply}
                </button>
              ))}
        ...
        >
          <input
            ...
            className="flex-1 bg-[#FFFFFF] border border-[#D8CFBC] rounded-sm px-4 py-2.5 text-sm focus:ring-1 focus:ring-[#2e2e2e] focus:border-[#2e2e2e] placeholder-[#293133]"
          />
          <button
            type="submit"
            disabled={!input.trim()}
