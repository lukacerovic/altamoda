    ...
    <NodeViewWrapper className="my-4" data-drag-handle>
      ...
      >
        ...
        {selected && (
          <>
            {/* Border */}
            <div className="absolute inset-0 rounded-md ring-2 ring-[#1a1c1e] ring-offset-2 pointer-events-none" />
            ...
            {(
              ...
              <div
                ...
                className="absolute w-3 h-3 bg-white border-2 border-[#1a1c1e] rounded-full z-10 hover:scale-125 transition-transform"
                style={{
                  cursor: h.cursor,
            ...
            <div
              ...
              className="absolute top-1/2 -right-2 -translate-y-1/2 w-1.5 h-10 bg-[#1a1c1e] rounded-full cursor-ew-resize z-10 opacity-60 hover:opacity-100 transition-opacity"
            />

            {/* Floating toolbar below image */}
            <div className="absolute -bottom-14 left-1/2 -translate-x-1/2 whitespace-nowrap flex items-center gap-0.5 bg-[#1a1c1e] text-white rounded-lg shadow-xl px-1.5 py-1 z-20">
